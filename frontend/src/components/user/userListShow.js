...
import UserShowListItem from "./userShowListItem";
        ...
        <div>
           ...
           <div className="container">
            ...
            <div className="row">
                <div className="col">
                    <div className="row">
                        {allShows.map(show=><UserShowListItem key={show._id} show={show} refresh={fetchShows}/>)}
                    </div>
                </div>
            </div>
        </div>
...
export default checkUser(UserListShow);